 ...
 */
package pbo310117087latihan30cakep;
 ...
 * Kelas             : IF - 3
 * NIM               : 10117087
 * Deskripsi Program : KASEP
 */

import java.util.Scanner;
public class Pbo310117087latihan30cakep {
    ...
    public static final String ANSI_WHITE = "\u011B[37m";
    ...
    public static void main(String[] args) {
        ...
        if (jawaban.equals("YOI")){
            ...
            System.out.print(ANSI_CYAN+"\nSing penting paham konsep nya mvang "
                    +ANSI_RESET);
            System.out.println(ANSI_BLACK+"\nKeep the code works mvang."+ANSI_RESET);
        }
