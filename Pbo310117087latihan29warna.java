 ...
 */
package pbo310117087latihan29warna;
...
public class Pbo310117087latihan29warna {
    ...
    case "MERAH":
        ...
        System.out.println("1. Periang, \n"+ "2. Pemberani,\n"+ "3. Berani "
                + "mengambil risiko dalam setiap langkah,\n"
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n====HASIL TEST KEPRIBADIAN "+ namaMu.toUpperCase()
                +"====");
        hasilTest(warnaMu);
    }
